import { Home, Mic, ClipboardList, BarChart3, MessageCircle, CalendarDays } from "lucide-react";
import { cn } from "@/lib/utils";
import { useLanguage, t } from "@/lib/nouri-i18n";

export type TabKey = "today" | "log" | "ask" | "plan" | "history" | "insights";
...
export function TabBar({
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-30 bg-surface/95 backdrop-blur border-t border-border">
      <div className="max-w-md mx-auto grid grid-cols-6 px-1 pt-2 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
