...
const STRINGS: Record<LangCode, Partial<Dict>> = {
  ...
  fr: {
    ...
    logMealTitle: "Enregistrer un repas",
    logMealHelp: "Appuyez sur le micro et décrivez ce que vous avez mangé. Je calcule.",
    stopRecording: "Arrêter l'enregistrement", startRecording: "Démarrer l'enregistrement",
    recordingTap: "Enregistrement… appuyez pour arrêter",
    transcribingAudio: "Transcription de l'audio…",
    tapToRecord: "Appuyez pour enregistrer",
    voiceUnsupported: "Voix non prise en charge — tapez ci-dessous",
    orTypeInstead: "ou écrivez à la place",
    logExamplePlaceholder: "ex. 100g de riz, 150g de poulet grillé, une cuillère d'huile d'olive",
    calculatingMacros: "Calcul des macros…", send: "Envoyer",
    tryAnExample: "Essayez un exemple", describeMealFirst: "Décrivez d'abord votre repas",
    loggedToast: "{name} enregistré", logged: "Enregistré",
    anythingElse: "Autre chose ?", thinking: "Réflexion…",
    didntCatchThat: "Je n'ai pas compris — réessayez ou tapez votre repas ci-dessous.",
    couldntAnalyse: "Désolé — je n'ai pas pu analyser ({err}). Reformulez avec des quantités, ex. \"150g poulet, 80g riz\".",
    gotItPrefix: "C'est noté", tapLogIt: "Appuyez sur **Enregistrer** pour sauvegarder.",
    kcalShort: "kcal", gShort: "g",
    historyTitle: "Historique", noMealsLogged: "Aucun repas enregistré.",
    mealsCount: "{n} repas", proteinShort: "protéines",
    insightsTitle: "Aperçus",
    avgProteinDay: "Protéines moy. / jour", avgCaloriesDay: "Calories moy. / jour",
    caloriesLast7: "Calories — 7 derniers jours", proteinLast7: "Protéines — 7 derniers jours",
    goalDot: "Objectif",
  },
  de: {
    ...
    logMealTitle: "Mahlzeit eintragen",
    logMealHelp: "Tippe aufs Mikro und beschreibe, was du gegessen hast. Ich rechne.",
    stopRecording: "Aufnahme stoppen", startRecording: "Aufnahme starten",
    recordingTap: "Aufnahme… tippen zum Stoppen",
    transcribingAudio: "Audio wird transkribiert…",
    tapToRecord: "Tippen zum Aufnehmen",
    voiceUnsupported: "Sprache nicht unterstützt — unten tippen",
    orTypeInstead: "oder stattdessen tippen",
    logExamplePlaceholder: "z. B. 100g Reis, 150g gegrilltes Hähnchen, ein EL Olivenöl",
    calculatingMacros: "Makros werden berechnet…", send: "Senden",
    tryAnExample: "Probier ein Beispiel", describeMealFirst: "Beschreibe zuerst deine Mahlzeit",
    loggedToast: "{name} eingetragen", logged: "Eingetragen",
    anythingElse: "Noch etwas?", thinking: "Denke nach…",
    didntCatchThat: "Habe ich nicht verstanden — versuche es nochmal oder tippe unten.",
    couldntAnalyse: "Sorry — Analyse fehlgeschlagen ({err}). Formuliere mit Mengen, z. B. \"150g Hähnchen, 80g Reis\".",
    gotItPrefix: "Verstanden", tapLogIt: "Tippe **Speichern** zum Sichern.",
    kcalShort: "kcal", gShort: "g",
    historyTitle: "Verlauf", noMealsLogged: "Noch keine Mahlzeiten eingetragen.",
    mealsCount: "{n} Mahlzeiten", proteinShort: "Eiweiß",
    insightsTitle: "Einblicke",
    avgProteinDay: "Ø Eiweiß / Tag", avgCaloriesDay: "Ø Kalorien / Tag",
    caloriesLast7: "Kalorien — letzte 7 Tage", proteinLast7: "Eiweiß — letzte 7 Tage",
    goalDot: "Ziel",
  },
  es: {
    ...
    logMealTitle: "Registrar una comida",
    logMealHelp: "Pulsa el micro y describe lo que comiste. Yo hago las cuentas.",
    stopRecording: "Detener grabación", startRecording: "Iniciar grabación",
    recordingTap: "Grabando… pulsa para parar",
    transcribingAudio: "Transcribiendo el audio…",
    tapToRecord: "Pulsa para grabar",
    voiceUnsupported: "Voz no soportada — escribe abajo",
    orTypeInstead: "o escribe en su lugar",
    logExamplePlaceholder: "p. ej. 100g de arroz, 150g de pollo a la plancha, una cucharada de aceite",
    calculatingMacros: "Calculando macros…", send: "Enviar",
    tryAnExample: "Prueba un ejemplo", describeMealFirst: "Describe tu comida primero",
    loggedToast: "{name} registrado", logged: "Registrado",
    anythingElse: "¿Algo más?", thinking: "Pensando…",
    didntCatchThat: "No te entendí — vuelve a intentarlo o escribe abajo.",
    couldntAnalyse: "Lo siento — no pude analizar ({err}). Reformula con cantidades, p. ej. \"150g pollo, 80g arroz\".",
    gotItPrefix: "Entendido", tapLogIt: "Pulsa **Guardar** para guardar.",
    kcalShort: "kcal", gShort: "g",
    historyTitle: "Historial", noMealsLogged: "Aún no hay comidas registradas.",
    mealsCount: "{n} comidas", proteinShort: "proteína",
    insightsTitle: "Análisis",
    avgProteinDay: "Proteína media / día", avgCaloriesDay: "Calorías medias / día",
    caloriesLast7: "Calorías — últimos 7 días", proteinLast7: "Proteína — últimos 7 días",
    goalDot: "Objetivo",
  },
  it: {
    ...
    logMealTitle: "Registra un pasto",
    logMealHelp: "Tocca il microfono e descrivi cosa hai mangiato. Ai calcoli ci penso io.",
    stopRecording: "Ferma registrazione", startRecording: "Inizia registrazione",
    recordingTap: "Registrazione… tocca per fermare",
    transcribingAudio: "Trascrizione dell'audio…",
    tapToRecord: "Tocca per registrare",
    voiceUnsupported: "Voce non supportata — scrivi sotto",
    orTypeInstead: "oppure scrivi",
    logExamplePlaceholder: "es. 100g di riso, 150g di pollo alla griglia, un cucchiaio d'olio",
    calculatingMacros: "Calcolo dei macro…", send: "Invia",
    tryAnExample: "Prova un esempio", describeMealFirst: "Descrivi prima il pasto",
    loggedToast: "{name} registrato", logged: "Registrato",
    anythingElse: "Altro?", thinking: "Sto pensando…",
    didntCatchThat: "Non ho capito — riprova o scrivi sotto.",
    couldntAnalyse: "Mi spiace — analisi fallita ({err}). Riformula con le quantità, es. \"150g pollo, 80g riso\".",
    gotItPrefix: "Ricevuto", tapLogIt: "Tocca **Salva** per salvare.",
    kcalShort: "kcal", gShort: "g",
    historyTitle: "Cronologia", noMealsLogged: "Nessun pasto registrato.",
    mealsCount: "{n} pasti", proteinShort: "proteine",
    insightsTitle: "Analisi",
    avgProteinDay: "Proteine medie / giorno", avgCaloriesDay: "Calorie medie / giorno",
    caloriesLast7: "Calorie — ultimi 7 giorni", proteinLast7: "Proteine — ultimi 7 giorni",
    goalDot: "Obiettivo",
  },
  pt: {
    ...
    logMealTitle: "Registar uma refeição",
    logMealHelp: "Toque no micro e descreva o que comeu. Eu faço as contas.",
    stopRecording: "Parar gravação", startRecording: "Iniciar gravação",
    recordingTap: "A gravar… toque para parar",
    transcribingAudio: "A transcrever o áudio…",
    tapToRecord: "Toque para gravar",
    voiceUnsupported: "Voz não suportada — escreva abaixo",
    orTypeInstead: "ou escreva",
    logExamplePlaceholder: "ex. 100g de arroz, 150g de frango grelhado, uma colher de azeite",
    calculatingMacros: "A calcular macros…", send: "Enviar",
    tryAnExample: "Experimente um exemplo", describeMealFirst: "Descreva primeiro a refeição",
    loggedToast: "{name} registado", logged: "Registado",
    anythingElse: "Mais alguma coisa?", thinking: "A pensar…",
    didntCatchThat: "Não percebi — tente de novo ou escreva abaixo.",
    couldntAnalyse: "Desculpe — não consegui analisar ({err}). Reformule com quantidades, ex. \"150g frango, 80g arroz\".",
    gotItPrefix: "Entendido", tapLogIt: "Toque em **Guardar** para guardar.",
    kcalShort: "kcal", gShort: "g",
    historyTitle: "Histórico", noMealsLogged: "Sem refeições registadas.",
    mealsCount: "{n} refeições", proteinShort: "proteína",
    insightsTitle: "Análises",
    avgProteinDay: "Proteína média / dia", avgCaloriesDay: "Calorias médias / dia",
    caloriesLast7: "Calorias — últimos 7 dias", proteinLast7: "Proteína — últimos 7 dias",
    goalDot: "Objetivo",
  },
  nl: {
    ...
    logMealTitle: "Maaltijd loggen",
    logMealHelp: "Tik op de microfoon en beschrijf wat je at. Ik reken het uit.",
    stopRecording: "Opname stoppen", startRecording: "Opname starten",
    recordingTap: "Opnemen… tik om te stoppen",
    transcribingAudio: "Audio wordt getranscribeerd…",
    tapToRecord: "Tik om op te nemen",
    voiceUnsupported: "Spraak niet ondersteund — typ hieronder",
    orTypeInstead: "of typ in plaats daarvan",
    logExamplePlaceholder: "bv. 100g rijst, 150g gegrilde kip, een eetlepel olijfolie",
    calculatingMacros: "Macros berekenen…", send: "Verzenden",
    tryAnExample: "Probeer een voorbeeld", describeMealFirst: "Beschrijf eerst je maaltijd",
    loggedToast: "{name} gelogd", logged: "Gelogd",
    anythingElse: "Nog iets?", thinking: "Aan het denken…",
    didntCatchThat: "Niet verstaan — probeer opnieuw of typ hieronder.",
    couldntAnalyse: "Sorry — analyse mislukt ({err}). Herformuleer met hoeveelheden, bv. \"150g kip, 80g rijst\".",
    gotItPrefix: "Begrepen", tapLogIt: "Tik op **Opslaan** om te bewaren.",
    kcalShort: "kcal", gShort: "g",
    historyTitle: "Geschiedenis", noMealsLogged: "Nog geen maaltijden gelogd.",
    mealsCount: "{n} maaltijden", proteinShort: "eiwit",
    insightsTitle: "Inzichten",
    avgProteinDay: "Gem. eiwit / dag", avgCaloriesDay: "Gem. calorieën / dag",
    caloriesLast7: "Calorieën — laatste 7 dagen", proteinLast7: "Eiwit — laatste 7 dagen",
    goalDot: "Doel",
  },
  ar: {
    ...
    logMealHelp: "اضغط على المايك وصف ما أكلته. سأقوم بالحسابات.",
    stopRecording: "إيقاف التسجيل", startRecording: "بدء التسجيل",
    recordingTap: "جارٍ التسجيل… اضغط للإيقاف",
    transcribingAudio: "جارٍ تفريغ الصوت…",
    tapToRecord: "اضغط للتسجيل",
    voiceUnsupported: "الصوت غير مدعوم — اكتب بالأسفل",
    orTypeInstead: "أو اكتب بدلًا من ذلك",
    logExamplePlaceholder: "مثال: 100غ أرز، 150غ دجاج مشوي، ملعقة زيت زيتون",
    calculatingMacros: "حساب الماكروز…", send: "إرسال",
    tryAnExample: "جرّب مثالًا", describeMealFirst: "صف وجبتك أولًا",
    loggedToast: "تم تسجيل {name}", logged: "تم التسجيل",
    anythingElse: "أي شيء آخر؟", thinking: "أفكر…",
    didntCatchThat: "لم أفهم — حاول مجددًا أو اكتب بالأسفل.",
    couldntAnalyse: "آسف — لم أستطع التحليل ({err}). أعد الصياغة مع الكميات، مثل \"150غ دجاج، 80غ أرز\".",
    gotItPrefix: "تمام", tapLogIt: "اضغط **حفظ** للحفظ.",
    kcalShort: "سعرة", gShort: "غ",
    historyTitle: "السجل", noMealsLogged: "لا توجد وجبات بعد.",
    mealsCount: "{n} وجبات", proteinShort: "بروتين",
    insightsTitle: "تحليلات",
    avgProteinDay: "متوسط البروتين / يوم", avgCaloriesDay: "متوسط السعرات / يوم",
    caloriesLast7: "السعرات — آخر 7 أيام", proteinLast7: "البروتين — آخر 7 أيام",
    goalDot: "الهدف",
  },
  zh: {
    ...
    logMealTitle: "记录一餐",
    logMealHelp: "点击麦克风并描述你吃了什么，我来算。",
    stopRecording: "停止录音", startRecording: "开始录音",
    recordingTap: "录音中… 点击停止",
    transcribingAudio: "正在转写音频…",
    tapToRecord: "点击开始录音",
    voiceUnsupported: "不支持语音 — 请在下方输入",
    orTypeInstead: "或者输入文字",
    logExamplePlaceholder: "例如：100克米饭、150克烤鸡、一勺橄榄油",
    calculatingMacros: "正在计算营养…", send: "发送",
    tryAnExample: "试试示例", describeMealFirst: "请先描述你的餐食",
    loggedToast: "已记录 {name}", logged: "已记录",
    anythingElse: "还有别的吗？", thinking: "思考中…",
    didntCatchThat: "没听清 — 请重试或在下方输入。",
    couldntAnalyse: "抱歉，无法分析（{err}）。请用份量重新描述，例如\"150克鸡肉、80克米饭\"。",
    gotItPrefix: "知道了", tapLogIt: "点击 **保存** 来保存。",
    kcalShort: "千卡", gShort: "克",
    historyTitle: "历史", noMealsLogged: "还没有记录任何餐食。",
    mealsCount: "{n} 餐", proteinShort: "蛋白质",
    insightsTitle: "分析",
    avgProteinDay: "日均蛋白质", avgCaloriesDay: "日均热量",
    caloriesLast7: "热量 — 最近 7 天", proteinLast7: "蛋白质 — 最近 7 天",
    goalDot: "目标",
  },
  ja: {
    ...
    logMealTitle: "食事を記録",
    logMealHelp: "マイクをタップして食べたものを話してください。計算は私が。",
    stopRecording: "録音を停止", startRecording: "録音を開始",
    recordingTap: "録音中… タップで停止",
    transcribingAudio: "音声を文字起こし中…",
    tapToRecord: "タップで録音開始",
    voiceUnsupported: "音声非対応 — 下に入力してください",
    orTypeInstead: "または入力",
    logExamplePlaceholder: "例：ご飯100g、グリルチキン150g、オリーブオイル大さじ1",
    calculatingMacros: "マクロを計算中…", send: "送信",
    tryAnExample: "例を試す", describeMealFirst: "まず食事を入力してください",
    loggedToast: "{name} を記録", logged: "記録済み",
    anythingElse: "他にはありますか？", thinking: "考え中…",
    didntCatchThat: "聞き取れませんでした — もう一度試すか下に入力してください。",
    couldntAnalyse: "ごめんなさい — 解析できませんでした（{err}）。量付きで言い換えてください。例：「鶏肉150g、ご飯80g」",
    gotItPrefix: "了解", tapLogIt: "**保存** をタップして保存。",
    kcalShort: "kcal", gShort: "g",
    historyTitle: "履歴", noMealsLogged: "まだ食事が記録されていません。",
    mealsCount: "{n} 食", proteinShort: "タンパク質",
    insightsTitle: "分析",
    avgProteinDay: "1日の平均タンパク質", avgCaloriesDay: "1日の平均カロリー",
    caloriesLast7: "カロリー — 過去7日", proteinLast7: "タンパク質 — 過去7日",
    goalDot: "目標",
  },
};
